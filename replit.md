...
**Statewide Scope**: 1,200 high school greenhouses (7,500 sqft avg, 9M sqft total), 712,500 students served (75% of 950K K-12 enrollment), 75 lb produce per student annually (53.4M lb total), $5B endowment (4.5% yield = $225M/year), 2,400 FTE jobs, ~3,100 total schools (1,200 with greenhouses). Anti-Boundary Waters mining alternative.
